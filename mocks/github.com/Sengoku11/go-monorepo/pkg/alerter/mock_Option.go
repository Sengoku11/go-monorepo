...
func (_m *MockOption) Execute(opts *alerter.Options) {
	_m.Called(opts)
}
...
func (_e *MockOption_Expecter) Execute(opts interface{}) *MockOption_Execute_Call {
	return &MockOption_Execute_Call{Call: _e.mock.On("Execute", opts)}
}

func (_c *MockOption_Execute_Call) Run(run func(opts *alerter.Options)) *MockOption_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*alerter.Options))
	})
	return _c
}
...
func (_c *MockOption_Execute_Call) RunAndReturn(run func(*alerter.Options)) *MockOption_Execute_Call {
	_c.Run(run)
	return _c
}
