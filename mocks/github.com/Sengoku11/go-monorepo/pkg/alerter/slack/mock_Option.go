...
import (
	slack "github.com/Sengoku11/go-monorepo/pkg/alerter/slack"
...
func (_m *MockOption) Execute(options *slack.Options) {
	_m.Called(options)
}
...
func (_c *MockOption_Execute_Call) Run(run func(options *slack.Options)) *MockOption_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*slack.Options))
	})
	return _c
}
...
func (_c *MockOption_Execute_Call) RunAndReturn(run func(*slack.Options)) *MockOption_Execute_Call {
	_c.Run(run)
	return _c
}
